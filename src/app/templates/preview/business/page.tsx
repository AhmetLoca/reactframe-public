...
export default function BusinessTemplatePreview() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-16">
      ...
      <h1 className="text-3xl font-semibold tracking-tight">Halstead &amp; Partners</h1>
      <p className="mt-3 max-w-xl text-foreground/60">A Business consulting landing page template, composed entirely from ReactFrame components.</p>

      <div className="mt-8">
        <LayoutPreview slug="business" basePath="/templates/preview" kind="template" />
      </div>
    </div>
  );
}
